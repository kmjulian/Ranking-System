<div class="container">
    <h1 class="well">Create Instructor Account</h1>
        ...
        <?php echo form_open('admin/cia_form_submit');?>
          ...
          <div class="row">
            ...
            <select name="dept" class="form-control">
                  <option selected="true" disabled="disabled">-- Select Departent --</option>
            ...
            <div class="form-group">
            <label>Assign Advisory Class</label>
            <select name="adv_class" class="form-control">
