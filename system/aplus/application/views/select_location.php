...
<body>
    ...
    <h1 class="welcome text-center">Welcome to A+</h1>
        ...
        <h2 class='login_title text-center'>Location</h2>
        <hr>

            <form class="form-signin" id="location" method="POST">
                <span id="reauth-email" class="reauth-email"></span>

                <p class="input_title">Region</p>
            	<select name="region" id="region" class="form-control">
            		<option selected="true" value='0'>-- Select Region --</option>
			        <?php foreach($regions as $region){  ?>
			        	<option value = "<?php echo $region->regionId;?>"><?php echo $region->regionName;?></option> 
			        <?php } ?>
            	</select></br>

				<p class="input_title">Province </p>
				<select name="province" id="province" class="form-control" disabled="">
					<option selected="true" value='0'>-- Select Province --</option>
                </select></br>
                ...
                <p class="input_title">Barangay</p>
                <select name="barangay" id="barangay" class="form-control" disabled="">
                	<option selected="true" value='0'>-- Select Barangay --</option>
                </select></br>

                <p class="input_title">School</p>
                <select name="school" id="school" class="form-control" disabled="">
                	<option selected="true" value='0'>-- Select School --</option>
                </select>

               </br>
             <!-- <input onclick="document.getElementById('id01').style.display='block'" class="btn btn-lg btn-primary" type="submit" /> -->

             <button class="btn btn-lg btn-primary" id="login" type="submit">Log in to this location</button>

             <button class="btn btn-lg btn-primary" id="reg" type="submit">Register as Student</button>
            ...
            <div class="modal-content animate">
                ...
                <div class="row">
                    <div class="col-sm-6 form-group">
                      <label>City</label>
                      <input type="text" name="city" placeholder="(ex. Makati City)" class="form-control">
                    </div>    
                    <div class="col-sm-6 form-group">
                      <label>Province</label>
                      <input type="text" name="province" placeholder="(ex. Quezon Province)" class="form-control">
                    </div>  
                  </div> 
                <div class="row">
                    <div class="col-sm-6 form-group">
                      <label>Phone Number</label>
                      <input type="text" name="phone" placeholder="(ex. 09123456789)" class="form-control">
                    </div>    
                    <div class="col-sm-6 form-group">
                      <label>Email Address</label>
                      <input type="text" name="email" placeholder="(ex. helloworld@gmail.com)" class="form-control">
                    </div>  
                    <div class="col-sm-6 form-group">
                      <label>Zip Code</label>
                      <input type="text" name="zip" placeholder="(ex. 1234)" class="form-control">
                    </div>  
                  </div> 
