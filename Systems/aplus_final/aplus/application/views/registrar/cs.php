<div class="container">
  ...
  <div class="row">
          <?php echo form_open('registrar/cs_form_submit');?>
          <div class="col-sm-12">
           <div class="form-group">
            <label>Educational Stage</label>
            <label>Level</label>
            <select name="level" placeholder="level" class="form-control" required>
            ...
            <div class="row">
              ...
              <div class="col-sm-4 form-group">
                ...
                <input type="text" name="capacity" placeholder="Capacity" class="form-control" required>
              </div>
            </div>  
