            ...
            <table class='rg-table' summary='Hed', id="table">
              ...
              <tbody>
                ...
                <td text-centered></td>
                  <td></td>
                  <?php if ($assignment !=0){ ?>
                  <td colspan="<?php echo $assignment;?>" text-centered>Assignment</td> <?php }?>
                   <?php if ($seatwork !=0){ ?>
                  <td colspan="<?php echo $seatwork;?>" text-centered>Seatwork</td><?php }?>
                  <?php if ($quiz !=0){ ?>
                  <td colspan="<?php echo $quiz;?>" text-centered>Quizzes</td><?php }?>
                  <?php if ($recitation !=0){ ?>
                  <td colspan="<?php echo $recitation;?>" text-centered>Recitation</td><?php }?>
                  <?php if ($gwork !=0){ ?>
                  <td colspan="<?php echo $gwork;?>" text-centered>Group Work</td><?php }?>
