    	...
    	<div class="col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Create Registrar Account</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?= site_url('district/create/create_registrar/create_registrar_account');?>" method="post">
              <div class="box-body">
                <div class="col-lg-4">
                ...
                <div class="col-lg-6">
                	<div class="form-group">
	                	<label for="dist" class="col-sm-10">District</label>
		                  <div class="col-sm-10">
		                    <input type="text" name="district" class="form-control" id="dist" value="3" placeholder="3" disabled>
		                  </div>
	              	</div>
                </div>
