...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="student_home" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('student/view/view_student_analytics');?>"><i class="fa fa-circle-o"></i> View Analytics</a></li>
            <li><a href="<?php echo site_url('student/view/view_student_result');?>"><i class="fa fa-circle-o"></i> View Results</a></li>
          </ul>
        </li>
      </ul>
    </section>
