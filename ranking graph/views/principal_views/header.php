      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('principal/view/view_school_analytics');?>"><i class="fa fa-circle-o"></i> View School Analytics</a></li>
            <li><a href="<?php echo site_url('principal/view/view_school_results');?>"><i class="fa fa-circle-o"></i> View School Result</a></li>
            <li><a href="<?php echo site_url('principal/view/view_school_users');?>"><i class="fa fa-circle-o"></i> View School Users</a></li>
          </ul>
        </li>
      </ul>
    </section>
