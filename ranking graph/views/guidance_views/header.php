...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="principal_home" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>G</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Guidance</b></span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('guidance/view/view_student_analytics');?>"><i class="fa fa-circle-o"></i> View Student Analytics</a></li>
            <li><a href="<?php echo site_url('guidance/view/view_student_profile');?>"><i class="fa fa-circle-o"></i> View Student Profile</a></li>
            <li><a href="<?php echo site_url('guidance/view/view_student_results');?>"><i class="fa fa-circle-o"></i> View Student Results</a></li>
          </ul>
        </li>
      </ul>
    </section>
