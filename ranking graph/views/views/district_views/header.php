...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="district_home" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>D</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>District</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Create Accounts</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('district/create/create_registrar');?>"><i class="fa fa-circle-o"></i> Registrar</a></li>
            <li><a href="<?php echo site_url('district/create/create_principal');?>"><i class="fa fa-circle-o"></i> Principal</a></li>
            <li><a href="<?php echo site_url('district/create/create_school');?>"><i class="fa fa-circle-o"></i> School</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('district/view/view_district_users');?>"><i class="fa fa-circle-o"></i> View District Users</a></li>
            <li><a href="<?php echo site_url('district/view/view_school_results');?>"><i class="fa fa-circle-o"></i> View School Results</a></li>
            <li><a href="<?php echo site_url('district/view/view_school_analytics');?>"><i class="fa fa-circle-o"></i> View School Analytics</a></li>
          </ul>
        </li>
      </ul>
    </section>
