    	...
    	<div class="col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Create Guidance Account</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?= site_url('registrar/create/create_guidance/create_guidance_account');?>" method="post">
              <div class="box-body">
                <div class="col-lg-4">
