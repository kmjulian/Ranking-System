      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('registrar/assign/assign_teacher');?>"><i class="fa fa-circle-o"></i> Teacher</a></li>
            <li><a href="<?php echo site_url('registrar/assign/assign_student');?>"><i class="fa fa-circle-o"></i> Student</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
             <li><a href="<?php echo site_url('registrar/create/create_section');?>"><i class="fa fa-circle-o"></i> Section</a></li>
            <li><a href="<?php echo site_url('registrar/create/create_guidance');?>"><i class="fa fa-circle-o"></i> Guidance</a></li>
            <li><a href="<?php echo site_url('registrar/create/create_teacher');?>"><i class="fa fa-circle-o"></i> Teacher</a></li>
            <li><a href="<?php echo site_url('registrar/create/create_student');?>"><i class="fa fa-circle-o"></i> Student</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('registrar/view/view_school_users');?>"><i class="fa fa-circle-o"></i> View Users</a></li>
          </ul>
        </li>
      </ul>
    </section>
