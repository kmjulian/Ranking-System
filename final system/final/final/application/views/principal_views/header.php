      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('principal/view/view_grade_level_analytics');?>"><i class="fa fa-circle-o"></i> View Grade Level Analytics</a></li>
            <li><a href="<?php echo site_url('principal/view/view_grade_level_results');?>"><i class="fa fa-circle-o"></i> View School Result</a></li>
