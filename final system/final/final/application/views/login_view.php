...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?=base_url()?>public/AdminLTE-2.4.2/dist/css/logstyle.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="<?=base_url()?>public/AdminLTE-2.4.2/plugins/iCheck/square/blue.css">
  ...
  <div class="containers">
    ...
    <div class="loginBox">
      <form class="form-container" action="?" method="post">
        ...
        <center><div class="form-group has-feedback">
...
<!-- iCheck -->
<script src="<?=base_url()?>public/AdminLTE-2.4.2/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
